...
@Component({
  selector: 'app-listado-seleccion-partido',
  templateUrl: './listado-seleccion-partido.component.html',
  styleUrls: ['./listado-seleccion-partido.component.css']
})
export class ListadoSeleccionPartidoComponent implements OnInit {

  @Input() listadoPartidos!: DatosPartido[];
  @Input() listadoMostrado!: DatosPartido[];

  // Evento para exportar el partido seleccionado
  @Output('partidoSeleccionado') emitirPartido: EventEmitter<DatosPartido> = new EventEmitter<DatosPartido>();
  ...
  seleccionarPartido(partido: DatosPartido) {
    this.emitirPartido.emit(partido);
  }
